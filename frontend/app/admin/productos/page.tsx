...
export default function AdminProductosPage() {
  ...
  return (
    <div className="p-8">
      ...
      <p className="text-sm text-stone-400 mb-6">Activá o desactivá productos de la tienda</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-stone-100 bg-stone-50">
                <th className="text-left px-5 py-3 text-xs text-stone-400 font-medium">Producto</th>
                <th className="text-left px-5 py-3 text-xs text-stone-400 font-medium">Categoría</th>
                <th className="text-right px-5 py-3 text-xs text-stone-400 font-medium">Precio</th>
                <th className="text-center px-5 py-3 text-xs text-stone-400 font-medium">Stock</th>
                <th className="text-center px-5 py-3 text-xs text-stone-400 font-medium">Estado</th>
                <th className="px-5 py-3 text-xs text-stone-400 font-medium" />
              </tr>
            </thead>
                  ...
                  <td className="px-5 py-3.5">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <p className="font-medium text-stone-800 truncate max-w-[180px]">{producto.nombre}</p>
                        <p className="text-xs text-stone-400">{producto.marca}</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-5 py-3.5 text-stone-500 capitalize">{producto.categoria_nombre}</td>
                  <td className="px-5 py-3.5 text-right font-semibold text-stone-800">${producto.precio_final}</td>
                  <td className="px-5 py-3.5 text-center">
                    <span className={`font-semibold ${producto.stock === 0 ? 'text-red-500' : 'text-stone-700'}`}>
                      {producto.stock}
                    </span>
                  </td>
                  <td className="px-5 py-3.5 text-center">
